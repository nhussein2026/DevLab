...
const dark = document.querySelectorAll(
  "body, .navbar, .nav-link, .contribution-section, .navigationLink, .hero-section, footer, .cta-button, .doc-section, seperator-section, #code-editor, #live-preview, #code-snippets, #contributions, code, pre, #code-block, #author, .tool-title, .line-span, .terminal_toolbar, .loadApiButton, .api-input, .flexbox-preview, .flex-item, .flexbox-generator, .user-inputs, #pagespeed, #lighthouse, #google-analytics, #w3c-css-validator, #w3c-markup-validator, #browserstack, #wave, #pingdom, #gtmetrix, #selenium, #can-i-use, #line-span"
);
